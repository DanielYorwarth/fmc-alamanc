...
const EventTimelineHorizontal = ({theme, event, title}) => {
  return (
    <Box>
      ...
      <Wrapper>
        {event && event.map(({date, time, title, colour=theme.colour.primary}) => 
        <DateWrapper flexDirection="column" key={title} minWidth="20rem" width="24rem" marginBottom={theme.spacing[1]} marginRight={theme.spacing[1]}>
